...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userToStore = response.data?.user || response.user || response.data;
  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen transition-colors duration-300 relative isolate overflow-hidden">
      
      <Navbar />

      {/* BACKGROUND BLOBS (Keep our theme) */}
            ...
            <div>
              <div className="relative mt-10">
                ...
                <div className="relative flex justify-center text-sm font-medium leading-6">
                  <span className="bg-white px-6 text-gray-900 dark:bg-gray-800 dark:text-gray-300 rounded-full">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <a
                  href="#"
                  className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent dark:bg-gray-900 dark:text-white dark:ring-gray-700 dark:hover:bg-gray-800"
                >
